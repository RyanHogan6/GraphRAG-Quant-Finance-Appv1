...
- Multi-collection (SEC + Company): FOR filing IN sec_filings FILTER filing.ticker IN @tickers LIMIT 50 FOR company IN Company FILTER company.ticker == filing.ticker RETURN MERGE(filing, {{marketCap: company.marketCap, employees: company.fullTimeEmployees}})
