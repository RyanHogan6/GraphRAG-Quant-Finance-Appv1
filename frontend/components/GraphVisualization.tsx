...
const collectionData = {
  ...
  sec: {
    ...
    highlight: 'Hierarchical: Filings → Sections → Sentences with FinBERT sentiment',
  },
  options: {
    name: 'Options Flow',
    count: '612+ daily',
  ...
  eia: {
    ...
    count: '1K+',
    description: 'Energy Information Administration: crude inventory, natgas storage, production, LNG exports',
    ...
    highlight: 'Weekly inventory reports affecting commodity prices',
  },
  predictionmarkets: {
    ...
    edges: ['market_mentions_company → Company', 'position_in_market (FROM positions)', 'market_has_price_history → price_history'],
    ...
    highlight: 'Whale tracking + position analysis + semantic company links',
  },
  traders: {
