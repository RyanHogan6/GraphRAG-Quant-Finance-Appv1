      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-16">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-dark-800 border border-gold/30 rounded-lg p-6 hover:border-gold/60 transition-all">
                  <h3 className="text-xl font-semibold text-gold mb-3">1. Knowledge Graphs</h3>
                ...
                <div className="bg-dark-800 border border-gold/30 rounded-lg p-6 hover:border-gold/60 transition-all">
                  <h3 className="text-xl font-semibold text-gold mb-3">2. Retrieval Augmented Generation</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="bg-dark-800 border border-gold/30 rounded-lg p-6 hover:border-gold/60 transition-all">
                  <h3 className="text-xl font-semibold text-gold mb-3">3. Semantic Search</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-dark-800 border border-gold/20 rounded-lg p-8 overflow-x-auto">
...
└───────────────────────────────────────────────────────────────────────┘`}
          ...
          <section>
            ...
            <div className="bg-dark-800 border border-gold/20 rounded-lg p-8">
              ...
              <div className="mt-8 p-4 bg-gold/10 border border-gold/30 rounded-lg">
                <p className="text-sm text-gold font-semibold mb-2">💡 Example Multi-Hop Query</p>
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {/* Step 1 */}
                <div className="bg-dark-800 border-l-4 border-green-500 p-6 rounded-r-lg">
                  <h4 className="font-semibold text-green-400 mb-2 text-lg">Step 1: Intent Detection</h4>
                  ...
                  <div className="bg-dark-900 p-3 rounded font-mono text-xs">
                ...
                {/* Step 2 */}
                <div className="bg-dark-800 border-l-4 border-blue-500 p-6 rounded-r-lg">
                  <h4 className="font-semibold text-blue-400 mb-2 text-lg">Step 2: Query Planning</h4>
                  <p className="text-gray-400 mb-3">
                  ...
                  <div className="bg-dark-900 p-3 rounded font-mono text-xs overflow-x-auto">
  ...
  FOR company IN Company
    ...
    RETURN {company, award}`}</pre>
                ...
                {/* Step 3 */}
                <div className="bg-dark-800 border-l-4 border-purple-500 p-6 rounded-r-lg">
                  <h4 className="font-semibold text-purple-400 mb-2 text-lg">Step 3: Parallel Execution</h4>
                  <p className="text-gray-400 mb-3">
                ...
                {/* Step 4 */}
                <div className="bg-dark-800 border-l-4 border-orange-500 p-6 rounded-r-lg">
                  <h4 className="font-semibold text-orange-400 mb-2 text-lg">Step 4: Synthesis & Analysis</h4>
                  <p className="text-gray-400 mb-3">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-dark-800 border border-gold/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gold mb-4">Frontend</h3>
                <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <div className="bg-dark-800 border border-gold/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gold mb-4">Backend</h3>
                <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <div className="bg-dark-800 border border-gold/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gold mb-4">Database</h3>
                <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <div className="bg-dark-800 border border-gold/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gold mb-4">Data Pipeline</h3>
                <ul className="space-y-2 text-gray-400 text-sm">
          ...
          <section>
            ...
            <div className="mt-8 bg-dark-800 border border-gold/20 rounded-lg p-6">
              <h4 className="font-semibold text-gold mb-4">Performance Optimizations</h4>
